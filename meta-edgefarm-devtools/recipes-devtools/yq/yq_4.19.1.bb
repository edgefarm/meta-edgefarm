...
LICENSE = "MIT"
LIC_FILES_CHKSUM = "file://${WORKDIR}/LICENSE-${BPN}-${PV};md5=e40a0dcd62f8269b9bff37fe9aa7dcc2"
...
SRC_URI_append = " https://raw.githubusercontent.com/mikefarah/yq/v${PV}/LICENSE;name=license;downloadfilename=LICENSE-${BPN}-${PV}"
